...
p2 = gp_Pnt(1.4025, 0.0, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(1.4025, 0.0, 0.0)
p2 = gp_Pnt(1.4025, 3.2775, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(1.4025, 3.2775, 0.0)
p2 = gp_Pnt(0.0, 3.2775, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(0.0, 3.2775, 0.0)
...
face = face_mkr.Face()
extruded = BRepPrimAPI_MakePrism(face, gp_Vec(0,0,-1)*32.43).Shape()
trsf = gp_Trsf(); trsf.SetTranslation(gp_Vec(0.0,0.0,32.43))
...
wires = []
edges = []
p1 = gp_Pnt(0.0, 23.152499999999996, 0.0)
p2 = gp_Pnt(56.25, 23.152499999999996, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(56.25, 23.152499999999996, 0.0)
p2 = gp_Pnt(56.25, 30.172500000000003, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(56.25, 30.172500000000003, 0.0)
p2 = gp_Pnt(0.0, 30.172500000000003, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(0.0, 30.172500000000003, 0.0)
p2 = gp_Pnt(0.0, 23.152499999999996, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
wire_mkr = BRepBuilderAPI_MakeWire()
for _e in edges: wire_mkr.Add(_e)
...
wires = []
edges = []
p1 = gp_Pnt(54.8475, 0.0, 0.0)
p2 = gp_Pnt(56.25, 0.0, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(56.25, 0.0, 0.0)
p2 = gp_Pnt(56.25, 3.2775, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(56.25, 3.2775, 0.0)
p2 = gp_Pnt(54.8475, 3.2775, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
p1 = gp_Pnt(54.8475, 3.2775, 0.0)
p2 = gp_Pnt(54.8475, 0.0, 0.0)
edge = BRepBuilderAPI_MakeEdge(p1, p2).Edge()
edges.append(edge)
wire_mkr = BRepBuilderAPI_MakeWire()
for _e in edges: wire_mkr.Add(_e)
